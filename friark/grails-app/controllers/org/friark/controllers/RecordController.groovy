...
class RecordController {
	...
	def save = {
		...
		if(recordService && recordService.metaClass.pickMethod("create", [Object.class] as Class[])){
			def (simplifiedRecordInstance, success) = recordService.create( params )
			withFormat {
	...
	def update = {
		...
		if(recordService && recordService.metaClass.pickMethod("update", [Object.class] as Class[])){
			def (simplifiedRecordInstance, success) = recordService.update( params )
			withFormat {
				html { render(view: "show", model: [simplifiedRecordInstance: simplifiedRecordInstance]) }
                xml { render simplifiedRecordInstance as XML }
