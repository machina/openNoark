...
/**
* A service with functions related to "Bevaring og kassasjoner".
*/
class KassasjonService {
	...
	* in the list
	* @param liste A list of document links 
	*/
	...
	* @param documents A list of documents description numbers that are to 
			   deleted
  	*/
	def kasser(List documents, slettTilMappe = false){
		documents.each{ dok ->
  	...
  	/**
	* Deletes a document. Deletion means the removal of all document 
	* objects and attached documents.
	* @param dok The document to delete.
  	*/
