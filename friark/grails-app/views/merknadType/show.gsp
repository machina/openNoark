                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:merknadTypeInstance, field:'id')}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">Merknad:</td>
