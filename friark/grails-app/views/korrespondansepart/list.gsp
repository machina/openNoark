                ...
                <table>
                    ...
                    <g:each in="${korrespondansepartInstanceList}" status="i" var="korrespondansepartInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean:korrespondansepartInstance, field:'korrespondanseparttype')}</td>
                        
                            <td>${fieldValue(bean:korrespondansepartInstance, field:'korrespondansepartnavn')}</td>
                        
                            <td>${fieldValue(bean:korrespondansepartInstance, field:'postadresse')}</td>
                        
                            <td>${fieldValue(bean:korrespondansepartInstance, field:'postnummer')}</td>
                        
                            <td>${fieldValue(bean:korrespondansepartInstance, field:'poststed')}</td>
