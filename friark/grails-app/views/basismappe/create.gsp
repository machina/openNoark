...
<html>
  <head>
    ...
    <title><g:message code="files.create" default="Create file"/></title>
  </head>
  <body>
    <div class="nav">
    ...
    <div class="body">
      <h1><g:message code="files.create" default="Create file"/></h1>
        ...
        <div class="dialog">
          <table>
            <tbody>
              ...
              <tr class="prop">
                <td valign="top" class="name">
                  <label for="mappetype"><g:message code="type" default="Type"/></label>
                </td>
