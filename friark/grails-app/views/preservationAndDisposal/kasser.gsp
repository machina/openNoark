...
<html>
    ...
    <body>
        ...
        <div class="body">
            <h1>Søk frem poster du ønsker å kassere</h1>
            <g:if test="${flash.message}">
            <div class="message">${flash.message}</div>
            </g:if>
            <div class="dialog">
							<div class="oversikt_form">
								<g:form action="kasser" method="GET">
                  ...
                  <h2>Mapper</h2>
                      ...
                      <g:each in="${filer}" var="file">
							...
							<div class="oversikt_liste">
								<h2>Treff</h2>
								<g:form method="POST" action="kasser">
									<table>
  		              <thead>
                        <tr>
                    ...
                    <g:each in="${liste}" var="dokumentdescriptionInstance" status="i">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean:dokumentdescriptionInstance, field:'description')}</td>
														<td><g:checkBox name="kasser_${dokumentdescriptionInstance.id}" value="${false}"/></td>

                        </tr>
                    </g:each>
                    </tbody>
      	          </table>
									<g:submitButton name="kasser_valgte" value="Kasser valgte dokumenter"/>  <g:checkBox name="slett_til_file" value="${false}"/> Slett opptil file
								</g:form>
            </div>
