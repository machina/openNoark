...
class SubFondsPeriodisationTests extends GrailsUnitTestCase {
   ...
   */
	...
	*/
   /*
   void testAddFileToFondsOrOverlap(){
		def (ark, del, reg) = createStructure()
   ...
   */
	...
	*/
   /*
   void testAddRegistrationToFileInOverlap(){
		def (ark, del, reg) = createStructure()
		def mappeService = new FileService()
		mappeService.commonService = new CommonService()
		mappeService.mappeIdGeneratorService = new MappeIdGeneratorService()
   ...
   */
	...
	*/
   /*
   void testFilesInClosedFondsPeriod(){
		def (ark, del, reg) = createStructure()
...
/*      void testTransferFileOverlap(){
   ...
   def createParams(Series del){
		def params = [ fileID: "2011/00001", 
                     fileType: "BasicFile", 
                     title:"mappe", 
                     officialTitle: "mappe", 
                     description:"mappe", 
